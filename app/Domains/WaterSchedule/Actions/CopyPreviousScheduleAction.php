...
final readonly class CopyPreviousScheduleAction
{
    public function __construct(
        private WaterScheduleRepositoryInterface $repository,
    ) {}

    public function execute(string $date, ?int $userId = null): int
    {
        return $this->repository->copyPreviousDay($date, $userId);
    }
}
