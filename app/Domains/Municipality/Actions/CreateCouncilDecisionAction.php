...
final readonly class CreateCouncilDecisionAction
{
    public function __construct(
        private CouncilDecisionRepositoryInterface $repository,
    ) {}

    public function execute(CouncilDecisionDTO $dto): CouncilDecision
    {
        $decision = $this->repository->create($dto->toArray());
