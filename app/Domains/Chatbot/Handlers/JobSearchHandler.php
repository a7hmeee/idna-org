...
final readonly class JobSearchHandler implements ChatResponseHandlerInterface
{
    ...
    {
        return $intent === ChatbotIntent::JobSearch;
    }
    ...
    public function handle(
        ...
        if (empty($jobs)) {
            return new ChatResponseData(
                message: 'عذرًا، ما لقيت وظيفة بهالاسم.',
                type: 'empty_state',
            );
        }

        $lines = ['نتائج البحث عن وظائف:'];
