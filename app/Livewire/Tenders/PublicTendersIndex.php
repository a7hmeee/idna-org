...
final class PublicTendersIndex extends Component
{
    use WithPagination;
    ...
    {
        $repo = app(TenderRepositoryInterface::class);
        $filter = $this->filter === 'featured' ? 'featured' : null;

        $tenders = $repo->getPublished(
        ...
        return view('livewire.tenders.public-tenders-index', [
            'tenders' => $tenders,
            'featured' => $featured,
            'carouselImages' => $carouselImages,
            'municipalityName' => $municipalityName,
        ])->layout('layouts.home', [
            'title' => 'المناقصات | ' . $municipalityName,
            'metaDescription' => 'تصفح جميع المناقصات والعطاءات في ' . $municipalityName . '، واطلع على شروط التقديم.',
        ]);
    }
}
