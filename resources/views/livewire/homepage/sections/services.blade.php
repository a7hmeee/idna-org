...
<section id="services" class="services-section" style="background:#FFFFFF;padding-top:clamp(44px,5vw,66px);padding-bottom:clamp(48px,5.5vw,78px);overflow:hidden;position:relative;">
    ...
    <div style="width:100%;max-width:1280px;margin:0 auto;padding:0 clamp(16px,2.5vw,36px);">
        ...
        <div class="services-header">
            ...
            {{-- View all services button — desktop: absolute left; tablet/mobile: below --}}
            @if ($publicServicesIndexUrl)
                <div class="services-header-action">
                    <a href="{{ $publicServicesIndexUrl }}" wire:navigate
