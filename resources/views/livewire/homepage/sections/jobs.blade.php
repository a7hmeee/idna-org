    ...
    <div class="container-home">
        <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12">
            <div>
                ...
                <h2 class="text-3xl sm:text-4xl lg:text-[38px] font-black text-text leading-tight">{{ $sectionTitle ?? 'فرص عمل ومكاتب معتمدة' }}</h2>
                @if ($sectionSubtitle)
        ...
        <div class="grid lg:grid-cols-2 gap-6">
            ...
            <div class="rounded-2xl border border-border bg-white p-5 sm:p-6 shadow-card">
                ...
                <div class="flex items-center justify-between gap-4 mb-5">
                    ...
                    @if (Route::has('public.engineering-offices.index'))
                        <a href="{{ route('public.engineering-offices.index') }}" wire:navigate class="text-xs font-bold text-primary hover:text-primary-dark transition-colors flex items-center gap-1 no-underline">
                            <span>عرض الكل</span>
                            <i data-lucide="arrow-left" class="w-3 h-3"></i>
                        </a>
                    @endif
