...
<body class="bg-background font-sans text-text antialiased">
    ...
    <button x-data="{ visible: false }"
            ...
            class="fixed bottom-6 left-6 z-40 w-12 h-12 rounded-xl bg-primary text-white shadow-lg hover:bg-primary-dark transition-all flex items-center justify-center cursor-pointer"
    ...
    @if (config('chatbot.public_widget.enabled', true))
