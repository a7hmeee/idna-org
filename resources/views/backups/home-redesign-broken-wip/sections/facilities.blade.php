...
<section id="public-facilities" data-reveal class="facilities-section" aria-label="المرافق العامة" role="region"
    ...
    <div style="width:100%;max-width:1280px;margin:0 auto;padding:0 clamp(16px,2.5vw,36px);">
        ...
        <x-home.section-head
            align="start"
            eyebrow="مرافق البلدية"
            eyebrowIcon="building-2"
            :title="$sectionTitle ?? 'المرافق العامة'"
            :subtitle="$sectionSubtitle ?? 'تعرف على المرافق العامة التي تديرها البلدية والخدمات التي تقدمها للمواطنين.'"
            :actionUrl="Route::has('public.facilities.index') ? route('public.facilities.index') : null"
            actionLabel="عرض جميع المرافق"
        />
