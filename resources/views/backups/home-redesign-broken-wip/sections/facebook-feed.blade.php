<section data-reveal id="facebook-feed" class="section-py bg-white overflow-hidden">
    <div class="container-home">
        <x-home.section-head
            eyebrow="آخر أخبار البلدية"
            eyebrowIcon="facebook"
            title="آخر أخبار البلدية"
            subtitle="تابع أحدث أخبار وإعلانات بلدية إذنا عبر صفحتنا الرسمية على فيسبوك"
        />
        ...
        {{-- Facebook Plugin container — centered, max 500px --}}
        <div wire:ignore class="max-w-[500px] w-full mx-auto mt-8">
            ...
            {{-- Fallback card — hidden until confirmed FB failed --}}
