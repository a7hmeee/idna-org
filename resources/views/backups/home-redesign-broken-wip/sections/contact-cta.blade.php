...
<section data-reveal id="contact" class="relative overflow-hidden" style="background:#176B32;">
    ...
    <div class="relative container-home section-py">
        <div class="text-center mb-10">
            ...
            <h2 class="text-3xl lg:text-[34px] font-black text-white">{{ $ctaTitle }}</h2>
        </div>

        <div class="grid lg:grid-cols-[1.3fr_1fr] gap-10 lg:gap-16 items-center">
            <div>
                <p class="text-sm sm:text-base leading-relaxed mb-8" style="color:rgba(255,255,255,0.7);">{{ $ctaDesc }}</p>
