...
<section id="council-decisions" data-reveal class="bg-white relative overflow-hidden" style="padding-top:80px;padding-bottom:80px;">
    ...
    <div class="relative z-10" style="width:100%;max-width:1280px;margin-left:auto;margin-right:auto;padding-left:clamp(16px,2.5vw,36px);padding-right:clamp(16px,2.5vw,36px);">
        ...
        {{-- HEADER --}}
        <x-home.section-head
            eyebrow="قرارات المجلس"
            eyebrowIcon="scroll-text"
            :title="$sectionTitle ?? 'قرارات المجلس البلدي'"
            :subtitle="$sectionSubtitle ?? 'اطلع على أحدث القرارات والمصادقات الرسمية الصادرة عن المجلس البلدي'"
        />
