...
<section id="departments" data-reveal class="departments-section" style="background:#FFFFFF;padding-top:clamp(54px,5.8vw,78px);padding-bottom:clamp(52px,5.8vw,78px);">
    ...
    <div style="width:100%;max-width:1280px;margin:0 auto;padding:0 clamp(16px,2.5vw,36px);">
        ...
        {{-- ============================= --}}
        <x-home.section-head
            eyebrow="أقسام البلدية"
            eyebrowIcon="building-2"
            :title="$sectionTitle ?? 'أقسام البلدية'"
            :subtitle="$sectionSubtitle ?? 'نضع بين يديك أهم أقسام البلدية والخدمات التي يقدمها كل قسم للمواطنين.'"
            :actionUrl="Route::has('public.departments.index') ? route('public.departments.index') : null"
