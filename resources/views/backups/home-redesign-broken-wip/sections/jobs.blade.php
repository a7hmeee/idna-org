<section id="jobs-offices" data-reveal class="section-py bg-surface-secondary overflow-hidden">
    <div class="container-home">
        <x-home.section-head
            eyebrow="الوظائف والمكاتب الهندسية"
            eyebrowIcon="briefcase"
            :title="$sectionTitle ?? 'فرص عمل ومكاتب معتمدة'"
