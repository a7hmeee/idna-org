...
<header <?php echo e($attributes->class(['sticky top-4 z-50 mx-4 mt-4 bg-surface/80 backdrop-blur-xl rounded-2xl border border-border shadow-sm', 'isolation-isolate'])); ?>>
