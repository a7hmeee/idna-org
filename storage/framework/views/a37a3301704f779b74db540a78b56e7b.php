...
<div style="background:white;width:100%;max-width:100%;overflow-x:hidden;">
    ...
    <?php echo $__env->renderWhen(in_array('services', $sectionKeys), 'livewire.homepage.sections.services', [
    ...
    <?php echo $__env->renderWhen(in_array('departments', $sectionKeys), 'livewire.homepage.sections.departments', [
    ...
    <?php echo $__env->renderWhen(in_array('facilities', $sectionKeys), 'livewire.homepage.sections.facilities', [
    ...
    <?php echo $__env->renderWhen(in_array('council_decisions', $sectionKeys), 'livewire.homepage.sections.council-decisions', [
    ...
    <?php echo $__env->renderWhen(in_array('tenders', $sectionKeys), 'livewire.homepage.sections.tenders', [
    ...
    <?php echo $__env->renderWhen(in_array('statistics', $sectionKeys) && (!empty($statistics) || !empty($autoStatistics)), 'livewire.homepage.sections.statistics', [
    ...
    <?php echo $__env->renderWhen(in_array('contact_cta', $sectionKeys), 'livewire.homepage.sections.contact-cta', [
        'settings' => $settings,
        'portalUrl' => $portalUrl,
