<div>
    ...
    <section class="relative flex items-end overflow-hidden"
             style="min-height:<?php echo e($heroHeight); ?>;padding-top:116px;border-radius:0 0 24px 24px;"
             <?php if($hasSlides): ?>
             x-data="{
                 current: 0,
                 total: <?php echo e($slides->count()); ?>,
                 interval: null,
                 autoplay: <?php echo e($hasMultiple ? 'true' : 'false'); ?>,
                 init() {
        ...
        <div class="absolute inset-0">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSlides): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div x-show="current === <?php echo e($i); ?>"
                         ...
                         role="group" aria-roledescription="slide" aria-label="<?php echo e($slide->title); ?>">
            ...
            <?php elseif($bgImage): ?>
                <img src="<?php echo e($bgImage); ?>" alt="" class="w-full h-full object-cover" style="animation:heroZoom 8s ease-out forwards;" fetchpriority="high" />
            <?php else: ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSlides && $hasMultiple): ?>
                ...
                <div style="max-width:750px;margin-right:6%;margin-left:auto;text-align:right;">
                            ...
                            <ol style="display:flex;flex-wrap:wrap;align-items:center;gap:8px;margin:0;padding:0;list-style:none;font-size:13px;color:rgba(255,255,255,0.75);">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $breadcrumb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <li style="display:flex;align-items:center;gap:8px;">
                                        ...
                                        <?php else: ?>
                                            <span style="font-weight:700;color:#F5B041;"><?php echo e($item['label']); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($displayBadge): ?>
                        <span style="display:inline-flex;align-items:center;gap:6px;padding:6px 14px;border-radius:9999px;font-size:11px;font-weight:700;background:rgba(46,125,50,0.9);backdrop-filter:blur(8px);color:white;margin-bottom:12px;box-shadow:0 4px 16px rgba(46,125,50,0.35);">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pageBadgeIcon): ?>
                                <i data-lucide="<?php echo e($pageBadgeIcon); ?>" style="width:12px;height:12px;"></i>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSlides): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div x-show="current === <?php echo e($i); ?>" x-transition:enter="transition-opacity duration-500" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slide->button_text && $slide->button_url): ?>
                                    <div style="margin-top:16px;">
                                        <a href="<?php echo e($slide->button_url); ?>"
                                           <?php if(parse_url($slide->button_url, PHP_URL_HOST) !== null && parse_url($slide->button_url, PHP_URL_HOST) !== request()->getHost()): ?> target="_blank" rel="noopener noreferrer" <?php else: ?> wire:navigate <?php endif; ?>
                                           ...
                                           onmouseout="this.style.background='rgba(255,255,255,0.12)'">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(parse_url($slide->button_url, PHP_URL_HOST) !== null && parse_url($slide->button_url, PHP_URL_HOST) !== request()->getHost()): ?>
                        ...
                        <div style="display:flex;align-items:center;gap:6px;margin-top:16px;" role="tablist" aria-label="مؤشرات الشرائح">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <button type="button" role="tab"
                                        :aria-selected="current === <?php echo e($i); ?>"
                                        :aria-label="'الشريحة ' + (<?php echo e($i + 1); ?>)"
                                        @click="goTo(<?php echo e($i); ?>)"
                                        :style="`width:<?php echo e($i === 0 ? '28' : '10'); ?>px;height:10px;border-radius:9999px;border:none;cursor:pointer;transition:all 0.3s;background:<?php echo e($i === 0 ? 'white' : 'rgba(255,255,255,0.4)'); ?>`"
                                        x-init="$watch('current', val => {
                                            $el.style.width = (val === <?php echo e($i); ?> ? '28px' : '10px');
                                            $el.style.background = (val === <?php echo e($i); ?> ? 'white' : 'rgba(255,255,255,0.4)');
                                        })">
                                </button>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
...
<?php /**PATH C:\Users\ahmed\idna-org\resources\views/livewire/public-page-carousel.blade.php ENDPATH**/ ?>