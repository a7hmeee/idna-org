...
<section id="public-facilities" class="facilities-section" aria-label="المرافق العامة" role="region"
    ...
    <div style="width:100%;max-width:1280px;margin:0 auto;padding:0 clamp(16px,2.5vw,36px);">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($total > 0): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($total === 1 && $featured): ?>
                <div style="margin-top:44px;">
                    <?php echo $__env->make('livewire.homepage.sections.facilities-featured', ['facility' => $featured, 'resolveIcon' => $resolveIcon], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            ...
            <?php else: ?>
                ...
                <div class="facilities-grid" style="display:grid;grid-template-columns:minmax(0,1.1fr) minmax(0,1fr);gap:clamp(16px,2vw,22px);margin-top:44px;min-width:0;">
                    ...
                    <div style="display:flex;flex-direction:column;gap:clamp(14px,1.6vw,20px);min-width:0;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($wide): ?>
                            <?php echo $__env->make('livewire.homepage.sections.facilities-wide', ['facility' => $wide, 'resolveIcon' => $resolveIcon], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($smallCards->isNotEmpty()): ?>
                            <div style="display:grid;grid-template-columns:1fr 1fr;gap:clamp(14px,1.6vw,20px);min-width:0;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $smallCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <?php echo $__env->make('livewire.homepage.sections.facilities-small', ['facility' => $facility, 'resolveIcon' => $resolveIcon], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <?php if (! $__env->hasRenderedOnce('27e8bb4d-d2aa-463c-8075-8d2c22d95e18')): $__env->markAsRenderedOnce('27e8bb4d-d2aa-463c-8075-8d2c22d95e18'); ?>
...
<?php /**PATH C:\Users\ahmed\idna-org\resources\views/livewire/homepage/sections/facilities.blade.php ENDPATH**/ ?>