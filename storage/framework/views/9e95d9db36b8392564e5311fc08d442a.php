...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2907877276-0', $__key);
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;">
                <p style="font-size:13px;color:#6B7280;margin:0;">
                    يوجد <span style="font-weight:700;color:#1F2937;"><?php echo e($tenders->total() ?? 0); ?></span> مناقصة
                </p>
            </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featured->isNotEmpty() && $filter !== 'featured'): ?>
                <div style="margin-bottom:28px;">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $featured; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a href="<?php echo e(route('public.tenders.show', $tender->slug)); ?>" wire:navigate
                               ...
                               onmouseout="this.style.borderColor='#FEF3C7';this.style.boxShadow='0 1px 3px rgba(0,0,0,0.03)';this.style.transform='translateY(0)'">
                                <div style="display:flex;align-items:flex-start;gap:14px;margin-bottom:10px;">
                                    ...
                                    <div style="min-width:0;flex:1;">
                                        <h3 style="font-size:14px;font-weight:700;color:#1F2937;margin:0 0 2px;"><?php echo e($tender->title_ar); ?></h3>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tender->tender_number): ?>
                                            <span style="font-size:11px;color:#9CA3AF;"><?php echo e($tender->tender_number); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                                <p style="font-size:12px;color:#9CA3AF;line-height:1.6;margin:0 0 10px;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;"><?php echo e($tender->summary); ?></p>
                                <div style="display:flex;align-items:center;gap:6px;font-size:11px;color:#9CA3AF;">
                                    ...
                                    <span class="truncate"><?php echo e($tender->issuing_department); ?></span>
                                </div>
                            </a>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenders->isEmpty()): ?>
            ...
            <?php else: ?>
                <div class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tenders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <a href="<?php echo e(route('public.tenders.show', $tender->slug)); ?>" class="block bg-white rounded-xl border border-gray-200 p-5 hover:shadow-sm transition-shadow" wire:navigate>
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex-1">
                                    <h3 class="font-bold text-text"><?php echo e($tender->title_ar); ?></h3>
                                    <p class="text-sm text-text-secondary mt-1 line-clamp-2"><?php echo e($tender->summary); ?></p>
                                    <div class="flex items-center gap-4 mt-3 text-xs text-text-tertiary flex-wrap">
                                        <span class="inline-flex items-center gap-1">
                                            <i data-lucide="building-2" class="w-3 h-3"></i>
                                            <?php echo e($tender->issuing_department ?? 'بلدية إذنا'); ?>

                                        </span>
                                        <span class="inline-flex items-center gap-1">
                                            <i data-lucide="calendar" class="w-3 h-3"></i>
                                            آخر موعد: <?php echo e($tender->submission_deadline?->format('Y/m/d') ?? '—'); ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tender->budget): ?>
                                            <span class="inline-flex items-center gap-1">
                                                ...
                                                <?php echo e(number_format((float) $tender->budget)); ?> <?php echo e($tender->budget_currency); ?>
                                ...
                                <div class="shrink-0 flex flex-col items-end gap-2">
                                    <span class="text-xs px-2.5 py-1 rounded-full font-semibold
                                        <?php if($tender->status->value === 'open'): ?> bg-success/10 text-success
                                        <?php elseif($tender->status->value === 'closed'): ?> bg-danger/10 text-danger
                                        <?php elseif($tender->status->value === 'awarded'): ?> bg-info/10 text-info
                                        <?php else: ?> bg-municipal-50 text-text-tertiary <?php endif; ?>">
                                        <?php echo e($tender->status->label()); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenders->hasPages()): ?>
                <div class="mt-10">
...
<?php /**PATH C:\Users\ahmed\idna-org\resources\views/livewire/tenders/public-tenders-index.blade.php ENDPATH**/ ?>