<div class="fixed bottom-5 left-4 z-[70] flex flex-col items-end gap-3 animate-chatbot-rise"
     x-data="{ open: <?php if ((object) ('widgetOpen') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('widgetOpen'->value()); ?>')<?php echo e('widgetOpen'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('widgetOpen'); ?>')<?php endif; ?>, showWelcome: true, toggleChat() { this.open = !this.open; if (this.open) { this.showWelcome = false; } else { this.showWelcome = true; } }, openChat() { this.open = true; this.showWelcome = false; }, closeChat() { this.open = false; this.showWelcome = true; } }"
    ...
    <div x-show="open"
        ...
        <header class="shrink-0 text-white px-4 py-3 flex items-center justify-between" style="background:linear-gradient(120deg,#0E4A2E 0%,#0B3A24 100%);">
            <div class="flex items-center gap-3">
                <div class="relative w-9 h-9 shrink-0">
                    ...
                    <img src="<?php echo e(asset('robot.png')); ?>"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($disclaimer): ?>
            <div class="shrink-0 bg-white/50 border-b border-white/20 px-4 py-2">
                <p class="text-[11px] text-text-secondary text-center"><?php echo e($disclaimer); ?></p>
            </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loading): ?>
                    <div class="flex justify-start gap-2">
                        <div class="relative w-8 h-8 shrink-0">
                            ...
                            <img src="<?php echo e(asset('robot.png')); ?>" alt="" class="relative w-8 h-8 object-contain drop-shadow-[0_2px_6px_rgba(0,0,0,0.35)]">
                        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($validationError): ?>
            <div class="shrink-0 bg-red-500/10 border-t border-red-400/30 px-4 py-2">
                <p class="text-xs text-red-300 text-center"><?php echo e($validationError); ?></p>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($chatEnabled): ?>
            <div class="shrink-0 bg-white border-t border-gray-200 p-2.5" dir="rtl">
                <form wire:submit.prevent="sendMessage" class="flex gap-2 items-end">
                    ...
                    <button type="submit"
                            <?php if($loading || empty(trim($message ?? ''))): ?> disabled <?php endif; ?>
...
<?php /**PATH C:\Users\ahmed\idna-org\resources\views/livewire/chatbot/chatbot-widget.blade.php ENDPATH**/ ?>