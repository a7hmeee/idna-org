    ...
    <div class="container-home py-14 lg:py-16">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="<?php echo e(route('home')); ?>" class="text-sm transition-colors duration-200 no-underline" style="color:rgba(255,255,255,0.55);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.55)'">الرئيسية</a></li>
                    ...
                    <li><a href="<?php echo e(Route::has('public.services.index') ? route('public.services.index') : '#services'); ?>" class="text-sm transition-colors duration-200 no-underline" style="color:rgba(255,255,255,0.55);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.55)'">الخدمات</a></li>
                    <li><a href="<?php echo e(Route::has('public.council.index') ? route('public.council.index') : '#council-members'); ?>" class="text-sm transition-colors duration-200 no-underline" style="color:rgba(255,255,255,0.55);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.55)'">المجلس البلدي</a></li>
                    <li><a href="<?php echo e(Route::has('public.departments.index') ? route('public.departments.index') : '#departments'); ?>" class="text-sm transition-colors duration-200 no-underline" style="color:rgba(255,255,255,0.55);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.55)'">الأقسام</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($portalUrl): ?>
                        <li><a href="<?php echo e($portalUrl); ?>" target="_blank" rel="noopener noreferrer" class="text-sm transition-colors duration-200 no-underline" style="color:rgba(255,255,255,0.55);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.55)'">بوابة الخدمات</a></li>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('public.services.index')): ?>
                        <li><a href="<?php echo e(route('public.services.index')); ?>" class="text-sm transition-colors duration-200 no-underline" style="color:rgba(255,255,255,0.55);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.55)'">جميع الخدمات</a></li>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('public.water-schedule')): ?>
                        <li><a href="<?php echo e(route('public.water-schedule')); ?>" class="text-sm transition-colors duration-200 no-underline" style="color:rgba(255,255,255,0.55);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.55)'">جدول توزيع المياه</a></li>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('public.jobs.index')): ?>
                        <li><a href="<?php echo e(route('public.jobs.index')); ?>" class="text-sm transition-colors duration-200 no-underline" style="color:rgba(255,255,255,0.55);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.55)'">الوظائف</a></li>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('public.facilities.index')): ?>
                        <li><a href="<?php echo e(route('public.facilities.index')); ?>" class="text-sm transition-colors duration-200 no-underline" style="color:rgba(255,255,255,0.55);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.55)'">المرافق العامة</a></li>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('public.announcements.index')): ?>
                        <li><a href="<?php echo e(route('public.announcements.index')); ?>" class="text-sm transition-colors duration-200 no-underline" style="color:rgba(255,255,255,0.55);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.55)'">الإعلانات</a></li>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </ul>
            </div>
                ...
                <ul class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <li class="flex items-start gap-2.5">
                            <i data-lucide="<?php echo e($contact['type'] === 'phone' ? 'phone' : ($contact['type'] === 'email' ? 'mail' : ($contact['type'] === 'mobile' ? 'smartphone' : 'map-pin'))); ?>" class="w-4 h-4 flex-shrink-0 mt-0.5" style="color:#C8A85A;"></i>
                            <div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($contact['label'])): ?>
                                    <p class="text-[11px] font-medium" style="color:rgba(255,255,255,0.35);"><?php echo e($contact['label']); ?></p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($contact['url'])): ?>
                                    <a href="<?php echo e($contact['url']); ?>" class="text-sm transition-colors duration-200 no-underline" style="color:rgba(255,255,255,0.65);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.65)'"><?php echo e($contact['value']); ?></a>
                                <?php else: ?>
                                    <span class="text-sm" style="color:rgba(255,255,255,0.65);"><?php echo e($contact['value']); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </li>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    ...
    <div style="border-top:1px solid rgba(255,255,255,0.05);">
        <div class="container-home py-4">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                <p class="text-xs" style="color:rgba(255,255,255,0.3);">جميع الحقوق محفوظة &copy; <?php echo e(date('Y')); ?> <?php echo e($municipalityName); ?></p>
