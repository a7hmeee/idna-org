...
<section id="news" class="overflow-hidden" style="background:#F8FAF8;padding-top:clamp(64px,6vw,100px);padding-bottom:clamp(64px,6vw,100px);">
    <div class="container-home">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allNews->isNotEmpty()): ?>
                    ...
                    <div class="grid lg:grid-cols-2 gap-0">
                        ...
                        <div class="flex flex-col justify-center p-6 sm:p-8">
                            ...
                            <div class="flex items-center gap-4 mt-5">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fFullDate): ?>
                                    <span class="flex items-center gap-1.5 text-xs font-medium" style="color:#8A9A8D;">
                                        <i data-lucide="calendar" class="w-3.5 h-3.5"></i>
                                        <?php echo e($fFullDate); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carouselNews->isNotEmpty()): ?>
                <div x-data="{
                    slides: <?php echo \Illuminate\Support\Js::from($carouselNews->all())->toHtml() ?>,
                    slider: null,
                    currentPage: 0,
                    canPrev: false,
                    canNext: false,
                    ...
                    <div class="relative">
                        ...
                        <div x-ref="track" @scroll.throttle.100ms="refresh()" tabindex="0" role="region"
                             ...
                             ::style="'-ms-overflow-style:none;scrollbar-width:none;'">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $carouselNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $newsItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                    ...
                                    <a href="<?php echo e(!empty($newsItem['url']) ? $newsItem['url'] : '#'); ?>"
                                       ...
                                       onmouseout="this.style.boxShadow='0 1px 3px rgba(0,0,0,0.04)';this.style.transform='translateY(0)'">
                                        ...
                                        <div class="relative overflow-hidden" style="aspect-ratio:16/10;">
                                            ...
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($newsItem['category'])): ?>
                                                <span class="absolute top-3 right-3 px-2.5 py-0.5 rounded-full text-[11px] font-bold" style="background:#176B32;color:white;">
                                                    <?php echo e($newsItem['category']); ?>
