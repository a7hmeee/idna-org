...
?>
    ...
    <div class="max-w-3xl mx-auto px-4 py-8 space-y-6">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-4 mt-2 text-xs text-red-600">
                            <span class="flex items-center gap-1">
                                ...
                                من <?php echo e($activeMaintenance->starts_at->format('h:i A')); ?>

                            </span>
                            <span class="flex items-center gap-1">
                                <i data-lucide="clock" class="w-3 h-3"></i>
                                إلى <?php echo e($activeMaintenance->ends_at->format('h:i A')); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentSchedule): ?>
            <div class="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                <div class="text-center mb-6">
                    <p class="text-xs font-semibold text-text-tertiary uppercase tracking-wider">اليوم</p>
                    <p class="text-xl font-bold text-text mt-1"><?php echo e($todayDayName); ?></p>
                </div>

                <div class="flex items-center justify-center gap-8 mb-6">
                    <div class="text-center">
                        <p class="text-2xl font-bold text-text"><?php echo e($currentSchedule->start_time ? \Carbon\Carbon::parse($currentSchedule->start_time)->format('h:i A') : '—'); ?></p>
                    ...
                    <div class="text-center">
                        <p class="text-2xl font-bold text-text"><?php echo e($currentSchedule->end_time ? \Carbon\Carbon::parse($currentSchedule->end_time)->format('h:i A') : '—'); ?></p>
                ...
                <div class="text-center mb-6">
                    ...
                    ?>
                    <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold <?php echo e($colors['bg']); ?> <?php echo e($colors['text']); ?>">
                        <i data-lucide="<?php echo e($colors['icon']); ?>" class="w-4 h-4"></i>
                        <?php echo e($colors['label']); ?>

                    </span>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentSchedule->notes): ?>
                    <div class="border-t border-gray-100 pt-4 mt-4">
                        <p class="text-xs font-semibold text-text-tertiary mb-1">الملاحظات</p>
                        <p class="text-sm text-text-secondary"><?php echo e($currentSchedule->notes); ?></p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        <?php elseif($selectedAreaId): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($latestUpdate): ?>
            <div class="text-center py-4">
                <p class="text-xs text-text-tertiary">آخر تحديث</p>
                <p class="text-xs font-semibold text-text-secondary mt-0.5"><?php echo e($latestUpdate); ?></p>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <div class="text-center pt-4 pb-8 border-t border-gray-100">
            <p class="text-xs text-text-tertiary">جميع الحقوق محفوظة &copy; <?php echo e(date('Y')); ?> بلدية إذنا</p>
        </div>
    </div>
</div><?php /**PATH C:\Users\ahmed\idna-org\resources\views/livewire/water-schedule/public-water-schedule.blade.php ENDPATH**/ ?>