...
>
    ...
    <div class="flex items-center gap-3 px-4 h-[64px] shrink-0 border-b border-border/50 mx-3">
        <a href="<?php echo e(route('dashboard')); ?>" class="w-9 h-9 rounded-xl bg-primary flex items-center justify-center shrink-0 shadow-sm">
            <img src="<?php echo e(App\Domains\SharedKernel\Services\MediaResolver::logoUrl()); ?>" alt="بلدية إذنا" class="w-7 h-7 object-contain">
        </a>
    ...
    <nav class="flex-1 overflow-y-auto py-2 px-3 space-y-0.5">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $navGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupTitle => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                >
                    <i data-lucide="<?php echo e($item['icon']); ?>" class="w-[18px] h-[18px] shrink-0"></i>
                    <span x-show="sidebarOpen" x-transition><?php echo e($item['label']); ?></span>
                </a>
    ...
    <div class="border-t border-border/50 mx-3 py-2 space-y-0.5">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bottomItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <a href="<?php echo e($item['route'] ? route($item['route']) : '#'); ?>" class="sidebar-item hover:sidebar-item-hover">
                <i data-lucide="<?php echo e($item['icon']); ?>" class="w-[18px] h-[18px] shrink-0"></i>
                <span x-show="sidebarOpen" x-transition><?php echo e($item['label']); ?></span>
            </a>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
>
    ...
    <div class="flex items-center justify-between px-4 h-[64px] border-b border-border shrink-0">
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('dashboard')); ?>" class="w-9 h-9 rounded-xl bg-primary flex items-center justify-center shrink-0">
                <img src="<?php echo e(App\Domains\SharedKernel\Services\MediaResolver::logoUrl()); ?>" alt="بلدية إذنا" class="w-7 h-7 object-contain">
            </a>
            <div>
    ...
    <nav class="flex-1 overflow-y-auto py-3 px-3 space-y-1">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($bottomItems)): ?>
...
<?php if (! $__env->hasRenderedOnce('b5945366-b10e-4664-a6af-730b80076a9a')): $__env->markAsRenderedOnce('b5945366-b10e-4664-a6af-730b80076a9a'); ?>
    <style>
...
<?php endif; ?>
<?php /**PATH C:\Users\ahmed\idna-org\resources\views/components/sidebar.blade.php ENDPATH**/ ?>