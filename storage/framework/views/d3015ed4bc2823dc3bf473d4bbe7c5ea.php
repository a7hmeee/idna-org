...
>
    ...
    <div class="flex items-center gap-3 px-4 h-[64px] shrink-0 border-b border-border/50 mx-3">
        <a href="<?php echo e(route('dashboard')); ?>" class="w-9 h-9 rounded-xl bg-primary flex items-center justify-center shrink-0 shadow-sm">
            <img src="<?php echo e(asset('logo.png')); ?>" alt="بلدية إذنا" class="w-7 h-7 object-contain">
        </a>
...
<?php if (! $__env->hasRenderedOnce('55ac5d55-0ba9-430d-bc78-99483ee4b39a')): $__env->markAsRenderedOnce('55ac5d55-0ba9-430d-bc78-99483ee4b39a'); ?>
    <style>
